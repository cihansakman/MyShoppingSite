...
?>
            <form action="code.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="edit_admin_name" value="<?php echo $admin['user_name']; ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label> Surname </label>
                        <input type="text" name="edit_admin_surname" value="<?php echo $admin['user_surname']; ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="edit_admin_email" value="<?php echo $admin['user_email']; ?>" class="form-control" required>
                    </div>
                    

                    <a href="index.php" class="btn btn-danger">CANCEL</a>
                    <button type="submit" name="edit_admin_btn" class="btn btn-primary">UPDATE</button>
